...
public class WorkOrderOperationsFilter implements Serializable {
    ...
    public WorkOrderOperationsFilter() { }
    ...
    public void setOperationNumber(Long sequenceNumber) {
        this.operation_number = sequenceNumber;
    }
